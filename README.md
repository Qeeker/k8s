...
* Signály
  * Procesy na sebe musí vidět -> stejný namespace, [musí se explicitně zapnout](https://kubernetes.io/docs/tasks/configure-pod-container/share-process-namespace/)
...
* [Labrador](04-communication/01-communication-labrador.yaml)
  ...
  * Váže se na `Service`
  * Vyžaduje specifické [anotace](https://gitlab.seznam.net/ultra/SCIF/labrador/documentation/-/blob/master/kubernetes_reference.md)
  * Potřeba záznam v DNS manageru
